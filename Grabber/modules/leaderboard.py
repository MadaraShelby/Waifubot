...
async def global_leaderboard(update: Update, context: CallbackContext) -> None:
    ...
    photo_url = "https://telegra.ph/file/fe819714702ffe12381b3.jpg"  # Your photo URL
...
async def brotu(update: Update, context: CallbackContext) -> None:
    photo_url = 'https://telegra.ph/file/fe819714702ffe12381b3.jpg'  # Replace 'YOUR_PHOTO_URL_HERE' with your photo URL
