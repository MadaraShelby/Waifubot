...
async def ctop(update: Update, context: CallbackContext) -> None:
    ...
    photo_url = "https://telegra.ph/file/9b85adb50befcc32d8db3.jpg"  # Your photo URL
...
async def brotu(update: Update, context: CallbackContext) -> None:
    photo_url = 'https://telegra.ph/file/9b85adb50befcc32d8db3.jpg'  # Replace with your photo URL

    keyboard = [
        [
            InlineKeyboardButton("Add to Group", url='http://t.me/KokuProxbot?startgroup=new'),
            InlineKeyboardButton("Support Group", url='https://t.me/KokuSupportGroup')
        ],
        [
            InlineKeyboardButton("DUBBING ANIME GROUP", url='https://t.me/TheShelbyEmpire'),
    ...
    await update.message.reply_photo(photo=photo_url, caption="𝖧𝖾𝗒 Koku 𝗎𝗌𝖾𝗋𝗌, 𝗂𝖿 𝗒𝗈𝗎 𝗐𝖺𝗇𝗍 𝗍𝗈 𝖺𝖽𝖽 𝗒𝗈𝗎𝗋 𝖿𝖺𝗏𝗈𝗋𝗂𝗍𝖾 𝖼𝗁𝖺𝗋𝖺𝖼𝗍𝖾𝗋. 𝖸𝗈𝗎 𝖼𝖺𝗇 𝖺𝖽𝖽 𝖺𝗇𝗒 𝖼𝗁𝖺𝗋𝖺𝖼𝗍𝖾𝗋 𝗂𝗇 𝗍𝗁𝗂𝗌 𝗅𝗂𝗄𝖾 𝖠𝗇𝗂𝗆𝖾 , 𝖼𝖺𝗋𝗍𝗈𝗈𝗇 𝖺𝗇𝖽 𝖬𝖺𝗋𝗏𝖾𝗅 𝖾𝗍𝖼. 𝗒𝗈𝗎 𝖼𝖺𝗇 𝖽𝗆 𝗆𝖾 :- @sukuna201", reply_markup=reply_markup)
...
async def brotu(update: Update, context: CallbackContext) -> None:
    photo_url = 'https://telegra.ph/file/9b85adb50befcc32d8db3.jpg'  # Replace 'YOUR_PHOTO_URL_HERE' with your photo URL
